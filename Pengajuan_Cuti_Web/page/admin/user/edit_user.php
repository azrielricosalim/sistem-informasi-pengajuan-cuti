...
$pegawai_query = mysqli_query($koneksi, "SELECT 
    pegawai.*,
    multi_user.*,
    golongan.*,
    jabatan.*
...
<form class="form-add" method="POST" action="<?= BASE_URL . 'process/process_user/process_admin/process_edit.php'?>">
        <h1>form edit </h1>
    ...
    <div class="box">
        <div class="box-form">
            ...
            <div class="mb-3">
                <label for="nama_lengkap_admin" class="form-label">Nama lengkap</label>
                <input type="text" class="form-control" id="nama_lengkap_admin" name="nama_lengkap_admin" size="35" value="<?= $nama_lengkap ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select id="level" name="level" class="jenis">
                    <option value="<?= $level ?>" class="active" ><?= $level ?></option>
                </select>
            </div>
            <div class="mb-3">
