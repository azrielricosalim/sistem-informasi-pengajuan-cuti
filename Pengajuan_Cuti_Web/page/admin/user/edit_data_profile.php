...
// $user = mysqli_fetch_array (mysqli_query($koneksi, "SELECT * FROM tbl_multi_user WHERE id_user='$id_user'"));
...
<form class="form-add" method="POST" action="<?= BASE_URL . 'process/process_user/process_admin/process_update_admin.php'?>">
    <h1>PROFILE </h1>
