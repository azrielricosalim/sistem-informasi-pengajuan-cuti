...
$user = mysqli_query($koneksi, "SELECT * FROM tbl_data_ketua");
...
<h1 style="margin-bottom: 20px;">DATA PANITERA</h1>
    ...
    <table class="table1" >
        ...
        <tbody class="box-data">
            ...
            <td class="data-db"><?= $usr['nip_ketua']?></td>
            <td class="data-db2">
                ...
                <a class="btn1 btn-info badge"  href="<?= BASE_URL . 'dashboard_admin.php?page=edit_pk&id_ketua='.$usr['id_ketua'] ?>" >lihat form</a>
            </td>
            </tr>
            <?php endforeach;?>
        </tbody>
